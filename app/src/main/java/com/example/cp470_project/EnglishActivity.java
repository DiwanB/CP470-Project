...
public class EnglishActivity extends AppCompatActivity {
    public String ACTIVITY_NAME = "EnglishActivity";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button mL1 = findViewById(R.id.englishL1);
        Button mL2 = findViewById(R.id.englishL2);
        Button mL3 = findViewById(R.id.englishL3);
